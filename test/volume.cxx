...
int main()
{
  ...
  vtkm::UInt8 celltypes[8] = { vtkm::CELL_SHAPE_TETRA,   vtkm::CELL_SHAPE_HEXAHEDRON, vtkm::CELL_SHAPE_WEDGE,
  ...
  vtkm::io::writer::VTKDataSetWriter writer("ugrid_w_volume.vtk");
